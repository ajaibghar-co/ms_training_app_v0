...
const CLASS_NAMES = [];
const ADD_TRAINCLASS = document.getElementById('addtrainClass')
const CLASSGROUP = document.getElementById('classButtons')
...
ADD_TRAINCLASS.addEventListener('click', addTrainClasses)
...
function addTrainClasses() {
  ...
  b.setAttribute("class", "dataCollector")
  b.setAttribute("data-1hot", buttonnumber - 1)
  b.setAttribute("data-name", "Class " + buttonnumber)
  // document.body.appendChild(b)
  CLASSGROUP.appendChild(b);
